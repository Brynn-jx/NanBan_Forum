package com.NanBan.entity.query;
...
public class ForumCommentQuery extends BaseParam {
	...
	private List<Integer> pcomentIdList;

	public List<Integer> getPcomentIdList() {
		return pcomentIdList;
	}

	public void setPcomentIdList(List<Integer> pcomentIdList) {
		this.pcomentIdList = pcomentIdList;
	}
